...
def test_hr_app_login_logout(page: Page):
    ...
    expect(app_container).to_be_visible(timeout=30000) # Wait for the main app container
    ...
    login_button = form_container.locator('button[data-testid="baseButton-secondaryFormSubmit"]')
