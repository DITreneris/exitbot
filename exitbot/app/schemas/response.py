...
class ResponseBase(BaseModel):
    ...
    answer: Optional[str] = Field(None, description="The answer provided by the employee.")
    feedback: Optional[str] = Field(None, description="Feedback or notes related to the response.")
    metadata: Optional[Dict[str, Any]] = Field(None, description="Any additional metadata.")

# Schema for creating a Response (input)
class ResponseCreate(ResponseBase):
    interview_id: int = Field(..., description="The ID of the interview this response belongs to.")
    pass
