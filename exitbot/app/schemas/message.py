...
class Message(MessageBase):
    ...
    id: int = Field(..., description="Unique identifier for the message (note: often faked in list responses)")
    interview_id: int = Field(..., description="ID of the interview this message belongs to")
    role: MessageRole = Field(..., description="The role of the sender (user or assistant)")
