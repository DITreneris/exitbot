...
from exitbot.app.core.security import get_password_hash, verify_password

from exitbot.app.db.models import User
from exitbot.app.schemas.user import UserCreate # Assuming a UserCreate schema exists
