...
class TestEdgeCases:
    ...
    def test_unauthorized_interview_access(self, client, employee_token, admin_token, test_db):
        ...
        assert "not enough permissions to access this interview" in response.json()["detail"].lower()
    ...
    def test_interview_completion_idempotency(self, client: TestClient, admin_token_user: str, test_db: Session, test_employee: User):
        ...
        assert completed_at_second == completed_at_first # Timestamp shouldn't change ideally
