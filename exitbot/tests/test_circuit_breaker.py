...
class TestCircuitBreaker:
    ...
    def test_half_open_after_recovery_time(self):
        ...
        cb = CircuitBreaker(failure_threshold=3, recovery_time=2)  # Short recovery for testing
...
class TestCircuitBreakerIntegration:
    ...
    def test_client_uses_circuit_breaker(self):
        ...
        assert client.call_count == initial_call_count  # _send_request should not have been called
