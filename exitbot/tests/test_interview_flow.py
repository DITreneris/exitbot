...
class MockResponse:
    ...
    def sentiment_analysis(text):
        ...
        if any(word in lower_text for word in [
            "happy", "great", "excellent", "good", "love", "enjoy", "amazing", 
            "fantastic", "positive", "wonderful", "appreciate"
        ]):
            return {
                "response": "0.75"
            }
        ...
        # Negative words
        if any(word in lower_text for word in [
            "unhappy", "bad", "poor", "hate", "terrible", "awful", "disappointed", 
            "frustrated", "negative", "worst", "dislike"
        ]):
            return {
                "response": "-0.75"
            }
