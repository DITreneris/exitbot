"""
Test file for Groq LLM integration
"""
import pytest
import os
...
class TestGroqIntegration:
    ...
    def test_complete_failure_handling(self, mock_post):
        ...
        assert mock_post.call_count == expected_calls, f"Expected {expected_calls} calls, got {mock_post.call_count}"
    ...
    def test_sentiment_analysis(self, mock_post):
        ...
        mock_response = MagicMock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"choices": [{"message": {"content": "0.75"}}]}
        mock_post.return_value = mock_response
    ...
    def test_invalid_sentiment_response(self, mock_post):
        ...
        mock_response = MagicMock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"choices": [{"message": {"content": "This is positive"}}]}
        mock_post.return_value = mock_response
